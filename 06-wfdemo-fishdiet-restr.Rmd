...
```{r}
mortality <- read_csv("www/data/Moatt_et_al_Data_S1.csv")
courtship <- read_csv("www/data/Moatt_et_al_Data_S5.csv")
eggs <- read_csv("www/data/Moatt_et_al_Data_S6.csv")
length_weight_condition <- read_csv("www/data/Moatt_et_al_Data_S15.csv")
```
...
```{r}
diet_comp <- read_csv("www/data/diet_comp_treatments.csv")
