...
7. Details of a [live data analysis demonstration](#live-data-demo) we often use in our introductory undergraduate classes.
8. [More questions and datasets](#more-questions-data) that could be developed into new Workflow Demonstrations (perhaps for students to practice with and/or instructors to use.).
9. Some [Related reading](#related-reading).
