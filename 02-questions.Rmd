...
**Q3.2** How many bats were caught on each of the dates

**Q3.3** How many prey species were detected in total.

**Q3.4** How many prey species were migratory and non-migratory, and pest or non-pest, and each combination of migratory and pest.

**Q3.5** Plot at the shape of the distribution of dates on which poop samples were collected.

**Q3.6** Plot the distribution of number of reads. What shape is it? From looking at the distribution, predict whether the mean or median is larger. Then check your prediction by calculating the median and mean.
