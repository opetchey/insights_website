...
**Q4.1** How many times will you accidentally type in your code `=` when you meant to type `==`, and what is the difference?
...
**Q5.1** How many different prey *species* were detected in total.

**Q5.2** How many prey species were migratory and non-migratory, and pest or non-pest, and each combination of migratory and pest.
...
**Q5.4** How many bats were caught on each of the dates

**Q5.5** The Abstract of the paper states that Lepidoptera were mostly from the Noctuidae and Geometridae familes. How many species of Noctuidae and Geometridae are there in the dataset?
