...
You should be able to answer Question 3.1 after reading and working through Chapters 1 to 3. The other questions (3) 

**Q3.1** [The script without errors is here](assets/bat_diets_part1_insights_workflowdemo.R). Many of the errors were typos, and would have caused an error in R.
...
**Q3.3** Using projects makes our code more sharable, i.e. will work on someone elses computer without changing anything in the code. Switching between projects is simple.
...
**Q3.6** We store data in R in a *tibble*, whcih is a special type of data frame. It has rows each containing an observation, and columns containing variables.
...
**Q3.2** Calculate the total number of prey species by counting the number of unique values in the prey `Species` variable:
