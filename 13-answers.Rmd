...
*Perhaps go to a WFD other than the bats? The next question is a bit lame, and the answer is not fully present.*

**Q8.13** Work through the "What are the effects of dietary restriction?" workflow exercise up to and including question *Question 28: Write a few sentences about the distribution of each of the five response variables.*

Answer:
See the answer in the workflow exercise [solution web page](08-wfdemo-fishdiet-restr-solution.Rmd).
