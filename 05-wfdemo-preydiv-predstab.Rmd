...
```{r insight-sketch-4, fig.cap='A hypothetical outcome of the demonstration study of how a manipulation of diet composition and amount affect the lifespan of fish.', out.width='70%', fig.asp=.75, fig.align='center', echo=FALSE}
